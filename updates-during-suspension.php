...
$page = [
    'title'       => t('doc.suspension_updates') . ' · Mori Capital',
    'description' => t('doc.suspension.intro'),
    'breadcrumb'  => [
        ['label' => t('nav.home'), 'url' => asset('/')],
        ['label' => t('nav.documents')],
        ['label' => t('doc.suspension_updates')],
    ],
];
...
<div class="our-services" style="padding:50px 0;">
    <div class="container">
        <div style="margin-bottom:24px;max-width:780px;">
            ...
            <h2 style="font-size:clamp(24px,2.6vw,32px);margin:6px 0 8px;"><?= e(t('doc.suspension_updates')) ?></h2>
            <p style="font-size:14.5px;color:var(--mori-text-soft,#5A6B7B);line-height:1.6;margin:0;"><?= e(t('doc.suspension.intro')) ?></p>
        </div>
        <?php
        $emptyKey    = 'doc.no_suspension';
        $headerLabel = null;
