...
bm.add('cta-section', { label: 'CTA', category: 'Sections', media: '<i class="fa-solid fa-bullhorn" style="font-size:28px;color:#1ABC9C"></i>',
    content: '<section class="bg-light" style="padding:50px 30px;text-align:center;"><div class="container"><h2>Get in Touch</h2><p style="max-width:600px;margin:0 auto 20px;">Contact us to learn more about our investment approach.</p><a class="btn-default" href="/contact">Contact Us</a></div></section>' });
